        ...
        product: new Components\CheckoutProduct(
            ...
            medias: [
                new Components\ProductMediaFileRead(
                    ...
                    checksumSha256Base64: '<value>',
                    checksumSha256Hex: '<value>',
                    lastModifiedAt: Utils\Utils::parseDateTime('2024-12-28T05:58:27.332Z'),
                    version: '<value>',
                    isUploaded: false,
                    createdAt: Utils\Utils::parseDateTime('2024-07-31T06:56:56.038Z'),
                    sizeReadable: '<value>',
                    publicUrl: 'https://ironclad-privilege.net',
                ),
            ],
        ),
        productPrice: new Components\LegacyRecurringProductPriceFixed(
            createdAt: Utils\Utils::parseDateTime('2024-05-19T04:13:23.657Z'),
            modifiedAt: Utils\Utils::parseDateTime('2025-02-14T18:14:30.590Z'),
            id: '<value>',
            isArchived: false,
            productId: '<value>',
        ...
        attachedCustomFields: [
            new Components\AttachedCustomField(
                ...
                customField: new Components\CustomFieldDate(
                    createdAt: Utils\Utils::parseDateTime('2025-10-16T20:09:46.139Z'),
                    modifiedAt: Utils\Utils::parseDateTime('2023-09-29T18:20:07.088Z'),
                    id: '<value>',
                    metadata: [
                        'key' => '<value>',
                    ],

...
| `id`                                                                                                                                                                                                                                                                                                         | *string*                                                                                                                                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                                                                                                                                           | The subscription ID.                                                                                                                                                                                                                                                                                         |
| `customerSubscriptionUpdate`                                                                                                                                                                                                                                                                                 | [Components\CustomerSubscriptionUpdateProduct\|Components\CustomerSubscriptionUpdateSeats\|Components\CustomerSubscriptionCancel\|Components\CustomerSubscriptionPause\|Components\CustomerSubscriptionResume\|Components\CustomerSubscriptionUpdateClear](../../Models/Components/CustomerSubscriptionUpdate.md) | :heavy_check_mark:                                                                                                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                                                                                                          |
...
| Errors\AlreadyCanceledSubscription1 | 403                                 | application/json                    |

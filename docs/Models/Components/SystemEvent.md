...
```php
/**
* @var \Polar\Models\Components\SubscriptionPausedEvent
*/
Components\SubscriptionPausedEvent $value = /* values here */
```
...
```php
/**
* @var \Polar\Models\Components\SubscriptionResumedEvent
*/
Components\SubscriptionResumedEvent $value = /* values here */
```

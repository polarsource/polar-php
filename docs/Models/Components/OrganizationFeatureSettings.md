...
| `accountReviewV2Enabled`                                       | *?bool*                                                        | :heavy_minus_sign:                                             | If this organization sees the new account review checklist UI. |
...
| `billingEnabled`                                               | *?bool*                                                        | :heavy_minus_sign:                                             | If this organization has billing enabled                       |
...
class EventTypes
{
     ...
     * @param  string  $id
     * @return Operations\EventTypesUpdateEventTypeResponse
     * @throws \Polar\Models\Errors\APIException
     */
    public function updateEventType(Components\EventTypeUpdate $eventTypeUpdate, string $id, ?Options $options = null): Operations\EventTypesUpdateEventTypeResponse
    {
        $request = new Operations\EventTypesUpdateEventTypeRequest(
            id: $id,
            eventTypeUpdate: $eventTypeUpdate,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/event_types/{id}', Operations\EventTypesUpdateEventTypeRequest::class, $request);
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'event_types:update_event_type', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\EventTypesUpdateEventTypeResponse(

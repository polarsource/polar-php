...
class ExternalOrganizations
{
     ...
     */
    private function listIndividual(?Operations\ExternalOrganizationsListRequest $request = null, ?Options $options = null): Operations\ExternalOrganizationsListResponse
    {
        ...
        $hookContext = new HookContext($baseUrl, 'external_organizations:list', [], $this->sdkConfiguration->securitySource);
     ...
     * @throws \Polar\Models\Errors\APIException
     */
    public function list(?Operations\ExternalOrganizationsListRequest $request = null, ?Options $options = null): \Generator
    {

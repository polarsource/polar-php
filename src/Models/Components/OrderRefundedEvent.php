...
class OrderRefundedEvent
{
    ...
    /**
     *
     * @var OrderRefundedMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  OrderRefundedMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, OrderRefundedMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'order.refunded', ?int $childCount = 0)
    {
        $this->id = $id;

...
class OrderRefundedEvent
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, OrderRefundedMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $parentId = null, string $source = 'system', string $name = 'order.refunded', ?int $childCount = 0)
    {
        $this->id = $id;

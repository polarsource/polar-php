...
class BenefitSlackSharedChannel
{
    ...
    /**
     *
     * @var \Polar\Models\Components\BenefitSlackSharedChannelProperties $properties
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('properties')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\BenefitSlackSharedChannelProperties')]
    public BenefitSlackSharedChannelProperties $properties;
     ...
     * @param  \Polar\Models\Components\BenefitSlackSharedChannelProperties  $properties
     * @param  bool  $visibilityConfigurable
     * @param  ?\DateTime  $modifiedAt
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, string $description, bool $selectable, bool $deletable, bool $isDeleted, string $organizationId, array $metadata, BenefitVisibility $visibility, BenefitSlackSharedChannelProperties $properties, bool $visibilityConfigurable, ?\DateTime $modifiedAt = null, string $type = 'slack_shared_channel')
    {
        $this->id = $id;

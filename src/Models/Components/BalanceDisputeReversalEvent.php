...
class BalanceDisputeReversalEvent
{
    ...
    /**
     *
     * @var \Polar\Models\Components\BalanceDisputeMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  \Polar\Models\Components\BalanceDisputeMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, BalanceDisputeMetadata $metadata, ?string $customerId = null, CustomerIndividual|CustomerTeam|null $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'balance.dispute_reversal', ?int $childCount = 0)
    {
        $this->id = $id;

...
class CustomerBenefitGrantSlackSharedChannel
{
    ...
    /**
     *
     * @var \Polar\Models\Components\BenefitSlackSharedChannelSubscriber $benefit
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('benefit')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\BenefitSlackSharedChannelSubscriber')]
    public BenefitSlackSharedChannelSubscriber $benefit;
     ...
     * @param  \Polar\Models\Components\BenefitSlackSharedChannelSubscriber  $benefit
     ...
     * @phpstan-pure
     */
    public function __construct(\DateTime $createdAt, string $id, string $customerId, string $benefitId, bool $isGranted, bool $isRevoked, CustomerPortalCustomer $customer, BenefitSlackSharedChannelSubscriber $benefit, BenefitGrantSlackSharedChannelProperties $properties, ?\DateTime $modifiedAt = null, ?\DateTime $grantedAt = null, ?\DateTime $revokedAt = null, ?string $subscriptionId = null, ?string $orderId = null, ?string $memberId = null, ?BenefitGrantError $error = null)
    {

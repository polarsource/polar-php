...
class CustomerSubscriptionMeter
{
     ...
     * @phpstan-pure
     */
    public function __construct(\DateTime $createdAt, string $id, float $consumedUnits, int $creditedUnits, int $amount, string $meterId, CustomerSubscriptionMeterMeter $meter, ?\DateTime $modifiedAt = null)
    {

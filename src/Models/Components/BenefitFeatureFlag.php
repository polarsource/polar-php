...
class BenefitFeatureFlag
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, string $description, bool $selectable, bool $deletable, bool $isDeleted, string $organizationId, array $metadata, BenefitFeatureFlagProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'feature_flag')
    {
        $this->id = $id;

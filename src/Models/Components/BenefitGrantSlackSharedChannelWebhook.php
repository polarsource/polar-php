...
class BenefitGrantSlackSharedChannelWebhook
{
    ...
    /**
     *
     * @var \Polar\Models\Components\BenefitSlackSharedChannel $benefit
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('benefit')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\BenefitSlackSharedChannel')]
    public BenefitSlackSharedChannel $benefit;

    /**
     *
     * @var \Polar\Models\Components\BenefitGrantSlackSharedChannelProperties $properties
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('properties')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\BenefitGrantSlackSharedChannelProperties')]
    public BenefitGrantSlackSharedChannelProperties $properties;
    ...
    /**
     *
     * @var ?\Polar\Models\Components\BenefitGrantSlackSharedChannelProperties $previousProperties
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('previous_properties')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\BenefitGrantSlackSharedChannelProperties|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?BenefitGrantSlackSharedChannelProperties $previousProperties = null;
     ...
     * @param  \Polar\Models\Components\BenefitSlackSharedChannel  $benefit
     * @param  \Polar\Models\Components\BenefitGrantSlackSharedChannelProperties  $properties
     ...
     * @param  ?\Polar\Models\Components\BenefitGrantSlackSharedChannelProperties  $previousProperties
     * @phpstan-pure
     */
    public function __construct(\DateTime $createdAt, string $id, bool $isGranted, bool $isRevoked, string $customerId, string $benefitId, CustomerIndividual|CustomerTeam $customer, BenefitSlackSharedChannel $benefit, BenefitGrantSlackSharedChannelProperties $properties, ?\DateTime $modifiedAt = null, ?string $subscriptionId = null, ?string $orderId = null, ?\DateTime $grantedAt = null, ?\DateTime $revokedAt = null, ?string $memberId = null, ?BenefitGrantError $error = null, ?Member $member = null, ?BenefitGrantSlackSharedChannelProperties $previousProperties = null)
    {

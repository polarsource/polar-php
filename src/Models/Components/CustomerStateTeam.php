...
class CustomerStateTeam
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, array $metadata, bool $emailVerified, string $organizationId, array $activeSubscriptions, array $grantedBenefits, array $activeMeters, ?\DateTime $modifiedAt = null, ?string $name = null, ?string $billingName = null, ?Address $billingAddress = null, ?array $taxId = null, ?\DateTime $deletedAt = null, ?string $avatarUrl = null, ?string $externalId = null, ?string $email = null, ?string $locale = null, ?string $defaultPaymentMethodId = null, string $type = 'team')
    {
        $this->id = $id;

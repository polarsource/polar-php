...
class BenefitMeterCreditCreate
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $description, BenefitMeterCreditCreateProperties $properties, ?array $metadata = null, ?string $organizationId = null, string $type = 'meter_credit')
    {

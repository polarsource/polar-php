...
class BenefitMeterCreditCreate
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $description, BenefitMeterCreditCreateProperties $properties, ?array $metadata = null, ?string $organizationId = null, ?BenefitVisibility $visibility = null, string $type = 'meter_credit')
    {

...
class OrderPaidEvent
{
    ...
    /**
     *
     * @var OrderPaidMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  OrderPaidMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, OrderPaidMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'order.paid', ?int $childCount = 0)
    {
        $this->id = $id;

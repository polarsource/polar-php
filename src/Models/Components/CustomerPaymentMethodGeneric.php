...
class CustomerPaymentMethodGeneric
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, PaymentProcessor $processor, string $customerId, string $type, bool $isDefault, ?\DateTime $modifiedAt = null)
    {
        $this->id = $id;

...
class BenefitRevokedEvent
{
    ...
    /**
     *
     * @var \Polar\Models\Components\BenefitGrantMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  \Polar\Models\Components\BenefitGrantMetadata  $metadata

...
class BenefitFeatureFlagSubscriber
{
     ...
     *
     * @var \Polar\Models\Components\BenefitFeatureFlagSubscriberProperties $properties
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('properties')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\BenefitFeatureFlagSubscriberProperties')]
    public BenefitFeatureFlagSubscriberProperties $properties;
     ...
     * @param  \Polar\Models\Components\BenefitFeatureFlagSubscriberProperties  $properties
     * @param  ?\DateTime  $modifiedAt
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, string $description, bool $selectable, bool $deletable, string $organizationId, array $metadata, BenefitSubscriberOrganization $organization, BenefitFeatureFlagSubscriberProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'feature_flag')
    {
        $this->id = $id;

...
class BenefitGitHubRepository
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, array $metadata, string $description, bool $selectable, bool $deletable, string $organizationId, BenefitGitHubRepositoryProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'github_repository')
    {
        $this->id = $id;

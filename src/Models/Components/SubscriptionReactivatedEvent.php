...
class SubscriptionReactivatedEvent
{
    ...
    /**
     *
     * @var \Polar\Models\Components\SubscriptionReactivatedMetadata $metadata
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('metadata')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\SubscriptionReactivatedMetadata')]
    public SubscriptionReactivatedMetadata $metadata;
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  \Polar\Models\Components\SubscriptionReactivatedMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, SubscriptionReactivatedMetadata $metadata, ?string $customerId = null, CustomerIndividual|CustomerTeam|null $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'subscription.reactivated', ?int $childCount = 0)
    {
        $this->id = $id;

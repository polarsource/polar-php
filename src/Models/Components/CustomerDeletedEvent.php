...
class CustomerDeletedEvent
{
    ...
    /**
     *
     * @var \Polar\Models\Components\CustomerDeletedMetadata $metadata
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('metadata')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\CustomerDeletedMetadata')]
    public CustomerDeletedMetadata $metadata;
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  \Polar\Models\Components\CustomerDeletedMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, CustomerDeletedMetadata $metadata, ?string $customerId = null, CustomerIndividual|CustomerTeam|null $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'customer.deleted', ?int $childCount = 0)
    {
        $this->id = $id;

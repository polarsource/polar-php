...
class CustomerIndividualCreate
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $email, ?array $metadata = null, ?string $externalId = null, ?string $name = null, ?AddressInput $billingAddress = null, ?string $taxId = null, ?string $locale = null, ?string $organizationId = null, ?MemberOwnerCreate $owner = null, ?string $type = 'individual')
    {
        $this->email = $email;

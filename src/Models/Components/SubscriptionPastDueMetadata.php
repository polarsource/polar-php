...
class SubscriptionPastDueMetadata
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $subscriptionId, string $pastDueAt, ?string $productId = null, ?int $amount = null, ?string $currency = null, ?string $recurringInterval = null, ?int $recurringIntervalCount = null)
    {

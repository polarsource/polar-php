...
class CheckoutLinkCreateProducts
{
     ...
     * @phpstan-pure
     */
    public function __construct(array $products, ?array $metadata = null, ?TrialInterval $trialInterval = null, ?int $trialIntervalCount = null, ?string $label = null, ?string $discountId = null, ?int $seats = null, ?string $successUrl = null, ?string $returnUrl = null, string $paymentProcessor = 'stripe', ?bool $allowDiscountCodes = true, ?bool $requireBillingAddress = false)
    {

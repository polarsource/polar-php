...
class SubscriptionUncanceledEvent
{
    ...
    /**
     *
     * @var SubscriptionUncanceledMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  SubscriptionUncanceledMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, SubscriptionUncanceledMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'subscription.uncanceled', ?int $childCount = 0)
    {
        $this->id = $id;

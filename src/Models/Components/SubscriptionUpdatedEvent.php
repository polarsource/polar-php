...
class SubscriptionUpdatedEvent
{
    ...
    /**
     *
     * @var SubscriptionUpdatedProductMetadata|SubscriptionUpdatedDiscountMetadata|SubscriptionUpdatedTrialMetadata|SubscriptionUpdatedSeatsMetadata|SubscriptionUpdatedBillingPeriodMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  SubscriptionUpdatedProductMetadata|SubscriptionUpdatedDiscountMetadata|SubscriptionUpdatedTrialMetadata|SubscriptionUpdatedSeatsMetadata|SubscriptionUpdatedBillingPeriodMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, SubscriptionUpdatedProductMetadata|SubscriptionUpdatedDiscountMetadata|SubscriptionUpdatedTrialMetadata|SubscriptionUpdatedSeatsMetadata|SubscriptionUpdatedBillingPeriodMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'subscription.updated', ?int $childCount = 0)
    {
        $this->id = $id;

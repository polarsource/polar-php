...
class SubscriptionCanceledEvent
{
    ...
    /**
     *
     * @var SubscriptionCanceledMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  SubscriptionCanceledMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, SubscriptionCanceledMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'subscription.canceled', ?int $childCount = 0)
    {
        $this->id = $id;

...
class BenefitDiscordSubscriber
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, array $metadata, string $description, bool $selectable, bool $deletable, string $organizationId, Organization $organization, BenefitDiscordSubscriberProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'discord')
    {
        $this->id = $id;

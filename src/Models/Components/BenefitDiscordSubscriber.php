...
class BenefitDiscordSubscriber
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, string $description, bool $selectable, bool $deletable, bool $isDeleted, string $organizationId, array $metadata, BenefitSubscriberOrganization $organization, BenefitDiscordSubscriberProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'discord')
    {
        $this->id = $id;

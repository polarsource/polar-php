...
class DiscountFixedOnceForeverDuration
{
     ...
     * @phpstan-pure
     */
    public function __construct(DiscountDuration $duration, DiscountType $type, int $amount, string $currency, array $amounts, \DateTime $createdAt, string $id, array $metadata, string $name, int $redemptionsCount, string $organizationId, array $products, ?\DateTime $modifiedAt = null, ?string $code = null, ?\DateTime $startsAt = null, ?\DateTime $endsAt = null, ?int $maxRedemptions = null)
    {

...
class BenefitGrantLicenseKeysWebhook
{
    ...
    /**
     *
     * @var \Polar\Models\Components\BenefitLicenseKeys $benefit
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('benefit')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\BenefitLicenseKeys')]
    public BenefitLicenseKeys $benefit;
    ...
    /**
     *
     * @var ?\Polar\Models\Components\BenefitGrantLicenseKeysProperties $previousProperties
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('previous_properties')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\BenefitGrantLicenseKeysProperties|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?BenefitGrantLicenseKeysProperties $previousProperties = null;
     ...
     * @param  \Polar\Models\Components\BenefitLicenseKeys  $benefit
     ...
     * @param  ?\Polar\Models\Components\BenefitGrantLicenseKeysProperties  $previousProperties
     * @phpstan-pure
     */
    public function __construct(\DateTime $createdAt, string $id, bool $isGranted, bool $isRevoked, string $customerId, string $benefitId, CustomerIndividual|CustomerTeam $customer, BenefitLicenseKeys $benefit, BenefitGrantLicenseKeysProperties $properties, ?\DateTime $modifiedAt = null, ?string $subscriptionId = null, ?string $orderId = null, ?\DateTime $grantedAt = null, ?\DateTime $revokedAt = null, ?string $memberId = null, ?BenefitGrantError $error = null, ?Member $member = null, ?BenefitGrantLicenseKeysProperties $previousProperties = null)
    {

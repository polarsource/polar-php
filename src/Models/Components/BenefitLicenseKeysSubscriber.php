...
class BenefitLicenseKeysSubscriber
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, array $metadata, string $description, bool $selectable, bool $deletable, string $organizationId, Organization $organization, BenefitLicenseKeysSubscriberProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'license_keys')
    {
        $this->id = $id;

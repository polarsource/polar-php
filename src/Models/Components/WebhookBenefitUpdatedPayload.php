...
class WebhookBenefitUpdatedPayload
{
     ...
     * @phpstan-pure
     */
    public function __construct(BenefitCustom|BenefitDiscord|BenefitGitHubRepository|BenefitDownloadables|BenefitLicenseKeys|BenefitMeterCredit $data, string $type = 'benefit.updated')
    {
        $this->data = $data;
        $this->type = $type;
    }

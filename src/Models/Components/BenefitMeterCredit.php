...
class BenefitMeterCredit
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, array $metadata, string $description, bool $selectable, bool $deletable, string $organizationId, BenefitMeterCreditProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'meter_credit')
    {
        $this->id = $id;

...
class BenefitMeterCredit
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, string $description, bool $selectable, bool $deletable, bool $isDeleted, string $organizationId, array $metadata, BenefitMeterCreditProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'meter_credit')
    {
        $this->id = $id;

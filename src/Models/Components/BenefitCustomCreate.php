...
class BenefitCustomCreate
{
     ...
     *
     * @var \Polar\Models\Components\BenefitCustomCreateProperties $properties
     */
     ...
     * @param  \Polar\Models\Components\BenefitCustomCreateProperties  $properties
     * @param  ?array<string, string|int|float|bool>  $metadata
     * @param  ?string  $organizationId
     * @param  ?\Polar\Models\Components\BenefitVisibility  $visibility
     * @phpstan-pure
     */
    public function __construct(string $description, BenefitCustomCreateProperties $properties, ?array $metadata = null, ?string $organizationId = null, ?BenefitVisibility $visibility = null, string $type = 'custom')
    {

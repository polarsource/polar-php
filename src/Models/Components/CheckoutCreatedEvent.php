...
class CheckoutCreatedEvent
{
    ...
    /**
     *
     * @var CheckoutCreatedMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  CheckoutCreatedMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, CheckoutCreatedMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'checkout.created', ?int $childCount = 0)
    {
        $this->id = $id;

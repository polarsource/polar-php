...
class BalanceRefundReversalEvent
{
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  BalanceRefundMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, BalanceRefundMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'balance.refund_reversal', ?int $childCount = 0)
    {
        $this->id = $id;

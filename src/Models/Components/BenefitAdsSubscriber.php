...
class BenefitAdsSubscriber
{
     ...
     * @phpstan-pure
     */
    public function __construct(\DateTime $createdAt, string $id, string $description, bool $selectable, bool $deletable, string $organizationId, Organization $organization, BenefitAdsProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'ads')
    {

...
class BenefitFeatureFlagCreate
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $description, BenefitFeatureFlagCreateProperties $properties, ?array $metadata = null, ?string $organizationId = null, ?BenefitVisibility $visibility = null, string $type = 'feature_flag')
    {

...
class BenefitGitHubRepositoryCreate
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $description, BenefitGitHubRepositoryCreateProperties $properties, ?array $metadata = null, ?string $organizationId = null, ?BenefitVisibility $visibility = null, string $type = 'github_repository')
    {

...
class CustomerPaymentMethodCard
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, PaymentProcessor $processor, string $customerId, PaymentMethodCardMetadata $methodMetadata, bool $isDefault, ?\DateTime $modifiedAt = null, string $type = 'card')
    {
        $this->id = $id;

...
class CheckoutLinkCreateProduct
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $productId, ?array $metadata = null, ?string $label = null, ?string $discountId = null, ?string $successUrl = null, string $paymentProcessor = 'stripe', ?bool $allowDiscountCodes = true, ?bool $requireBillingAddress = false)
    {

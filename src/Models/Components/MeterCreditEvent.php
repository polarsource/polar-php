...
class MeterCreditEvent
{
    ...
    /**
     *
     * @var \Polar\Models\Components\MeterCreditedMetadata $metadata
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('metadata')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\MeterCreditedMetadata')]
    public MeterCreditedMetadata $metadata;
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  \Polar\Models\Components\MeterCreditedMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, MeterCreditedMetadata $metadata, ?string $customerId = null, CustomerIndividual|CustomerTeam|null $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'meter.credited', ?int $childCount = 0)
    {
        $this->id = $id;

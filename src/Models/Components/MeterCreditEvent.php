...
class MeterCreditEvent
{
    ...
    /**
     *
     * @var MeterCreditedMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  MeterCreditedMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, MeterCreditedMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'meter.credited', ?int $childCount = 0)
    {
        $this->id = $id;

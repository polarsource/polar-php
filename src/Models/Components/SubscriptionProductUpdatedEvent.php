...
class SubscriptionProductUpdatedEvent
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, SubscriptionProductUpdatedMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, string $source = 'system', string $name = 'subscription.product_updated', ?int $childCount = 0)
    {
        $this->id = $id;

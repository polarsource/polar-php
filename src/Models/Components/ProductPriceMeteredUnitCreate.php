...
class ProductPriceMeteredUnitCreate
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $meterId, int $unitAmount, ?int $capAmount = null, string $amountType = 'metered_unit', ?string $priceCurrency = 'usd', ?int $includedUnits = 0)
    {

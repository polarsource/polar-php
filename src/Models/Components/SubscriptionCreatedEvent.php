...
class SubscriptionCreatedEvent
{
    ...
    /**
     *
     * @var \Polar\Models\Components\SubscriptionCreatedMetadata $metadata
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('metadata')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\SubscriptionCreatedMetadata')]
    public SubscriptionCreatedMetadata $metadata;
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  \Polar\Models\Components\SubscriptionCreatedMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, SubscriptionCreatedMetadata $metadata, ?string $customerId = null, CustomerIndividual|CustomerTeam|null $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'subscription.created', ?int $childCount = 0)
    {
        $this->id = $id;

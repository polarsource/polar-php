...
class SubscriptionCreatedEvent
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, SubscriptionCreatedMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $parentId = null, string $source = 'system', string $name = 'subscription.created', ?int $childCount = 0)
    {
        $this->id = $id;

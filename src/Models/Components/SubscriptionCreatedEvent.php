...
class SubscriptionCreatedEvent
{
    ...
    /**
     *
     * @var SubscriptionCreatedMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  SubscriptionCreatedMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, SubscriptionCreatedMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'subscription.created', ?int $childCount = 0)
    {
        $this->id = $id;

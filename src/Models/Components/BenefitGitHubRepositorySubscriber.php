...
class BenefitGitHubRepositorySubscriber
{
     ...
     *
     * @var \Polar\Models\Components\BenefitGitHubRepositorySubscriberProperties $properties
     */
     ...
     * @param  \Polar\Models\Components\BenefitGitHubRepositorySubscriberProperties  $properties
     * @param  ?\DateTime  $modifiedAt
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, string $description, bool $selectable, bool $deletable, bool $isDeleted, string $organizationId, BenefitSubscriberOrganization $organization, BenefitGitHubRepositorySubscriberProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'github_repository')
    {
        $this->id = $id;

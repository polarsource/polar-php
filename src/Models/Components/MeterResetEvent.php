...
class MeterResetEvent
{
    ...
    /**
     *
     * @var MeterResetMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  MeterResetMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, MeterResetMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'meter.reset', ?int $childCount = 0)
    {
        $this->id = $id;

...
class MeterResetEvent
{
    ...
    /**
     *
     * @var \Polar\Models\Components\MeterResetMetadata $metadata
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('metadata')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\MeterResetMetadata')]
    public MeterResetMetadata $metadata;
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  \Polar\Models\Components\MeterResetMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, MeterResetMetadata $metadata, ?string $customerId = null, CustomerIndividual|CustomerTeam|null $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'meter.reset', ?int $childCount = 0)
    {
        $this->id = $id;

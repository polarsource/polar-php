...
class SupportCaseAttachmentFileCreate
{
    /**
     *
     * @var string $name
     ...
     * @phpstan-pure
     */
    public function __construct(string $name, string $mimeType, int $size, S3FileCreateMultipart $upload, ?string $organizationId = null, ?string $checksumSha256Base64 = null, ?string $version = null, string $service = 'support_case_attachment')
    {
        $this->name = $name;

...
class BenefitDownloadables
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, string $description, bool $selectable, bool $deletable, bool $isDeleted, string $organizationId, array $metadata, BenefitVisibility $visibility, BenefitDownloadablesProperties $properties, bool $visibilityConfigurable, ?\DateTime $modifiedAt = null, string $type = 'downloadables')
    {
        $this->id = $id;

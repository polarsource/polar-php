...
class BenefitCustomSubscriber
{
     ...
     *
     * @var \Polar\Models\Components\BenefitCustomSubscriberProperties $properties
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('properties')]
    #[\Speakeasy\Serializer\Annotation\Type('\Polar\Models\Components\BenefitCustomSubscriberProperties')]
    public BenefitCustomSubscriberProperties $properties;
     ...
     * @param  \Polar\Models\Components\BenefitCustomSubscriberProperties  $properties
     * @param  ?\DateTime  $modifiedAt
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $createdAt, string $description, bool $selectable, bool $deletable, bool $isDeleted, string $organizationId, array $metadata, BenefitSubscriberOrganization $organization, BenefitCustomSubscriberProperties $properties, ?\DateTime $modifiedAt = null, string $type = 'custom')
    {
        $this->id = $id;

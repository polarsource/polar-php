...
class BenefitCycledEvent
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, BenefitGrantMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, string $source = 'system', string $name = 'benefit.cycled', ?int $childCount = 0)
    {
        $this->id = $id;

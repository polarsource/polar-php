...
class SubscriptionBillingPeriodUpdatedEvent
{
    ...
    /**
     *
     * @var SubscriptionBillingPeriodUpdatedMetadata $metadata
     */
     ...
     * @param  string  $source
     * @param  string  $name
     * @param  SubscriptionBillingPeriodUpdatedMetadata  $metadata
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, \DateTime $timestamp, string $organizationId, string $label, SubscriptionBillingPeriodUpdatedMetadata $metadata, ?string $customerId = null, ?Customer $customer = null, ?string $externalCustomerId = null, ?string $memberId = null, ?string $externalMemberId = null, ?string $parentId = null, string $source = 'system', string $name = 'subscription.billing_period_updated', ?int $childCount = 0)
    {
        $this->id = $id;

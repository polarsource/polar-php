...
use Polar\Utils;
class PolarExceptionsNotPaidOrder
{
    /**
     *
     * @var string $error
    ...
    public function toException(): PolarExceptionsNotPaidOrderThrowable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new PolarExceptionsNotPaidOrderThrowable($message, (int) $code, $this);
    }
}
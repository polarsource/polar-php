...
use Polar\Utils;
class PolarExceptionsMissingInvoiceBillingDetails
{
    /**
     *
     * @var string $error
    ...
    public function toException(): PolarExceptionsMissingInvoiceBillingDetailsThrowable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new PolarExceptionsMissingInvoiceBillingDetailsThrowable($message, (int) $code, $this);
    }
}
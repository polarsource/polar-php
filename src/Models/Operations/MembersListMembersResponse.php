...
class MembersListMembersResponse
{
    /**
    ...
    /**
     * @var \Closure(string): ?MembersListMembersResponse $next
     */
    public \Closure $next;
    /**
    ...
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\ListResourceMember $listResourceMember = null)
    {
        ...
        $this->listResourceMember = $listResourceMember;
    }
    /**
     * @param  string  $name
     ...
     */
    public function __call($name, $args): ?MembersListMembersResponse
    {
        if ($name === 'next') {

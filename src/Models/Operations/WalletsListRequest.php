...
class WalletsListRequest
{
     ...
     *
     * @var ?array<Components\WalletSortProperty> $sorting
     */
     ...
     * @param  ?array<Components\WalletSortProperty>  $sorting
     * @phpstan-pure
     */
    public function __construct(string|array|null $organizationId = null, string|array|null $customerId = null, ?array $sorting = null, ?int $page = 1, ?int $limit = 10)
    {

...
class CheckoutsCustomListResponse
{
    /**
    ...
    /**
     * @var \Closure(string): ?CheckoutsCustomListResponse $next
     */
    public \Closure $next;
    /**
     ...
     * @return ?CheckoutsCustomListResponse
     */
    public function __call($name, $args): ?CheckoutsCustomListResponse
    {
        if ($name === 'next') {

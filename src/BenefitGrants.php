...
class BenefitGrants
{
    ...
    private function listIndividual(?Operations\BenefitGrantsListRequest $request = null, ?Options $options = null): Operations\BenefitGrantsListResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/benefit-grants/');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\BenefitGrantsListRequest::class, $request, $urlOverride);
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'benefit-grants:list', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\BenefitGrantsListResponse(
                ...
                $response->next = function () use ($sdk, $request, $responseData): ?Operations\BenefitGrantsListResponse {

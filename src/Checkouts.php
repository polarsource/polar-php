...
class Checkouts
{
     ...
     *
     * @param  \Polar\Models\Components\CheckoutConfirmStripe  $checkoutConfirmStripe
     * @param  string  $clientSecret
     * @return \Polar\Models\Operations\CheckoutsClientConfirmResponse
    ...
    {
        $request = new Operations\CheckoutsClientConfirmRequest(
            clientSecret: $clientSecret,
            checkoutConfirmStripe: $checkoutConfirmStripe,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/checkouts/client/{client_secret}/confirm', Operations\CheckoutsClientConfirmRequest::class, $request);
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'checkouts:client_confirm', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['400', '403', '404', '410', '422', '4XX', '5XX'])) {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\CheckoutsClientConfirmResponse(
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Polar\Models\Errors\PaymentError', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $clientSecret
     * @return \Polar\Models\Operations\CheckoutsClientGetResponse
     * @throws \Polar\Models\Errors\APIException
     */
    public function clientGet(string $clientSecret, ?Options $options = null): Operations\CheckoutsClientGetResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'checkouts:client_get', null, null);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     *
     * @param  \Polar\Models\Components\CheckoutUpdatePublic  $checkoutUpdatePublic
     * @param  string  $clientSecret
     * @return \Polar\Models\Operations\CheckoutsClientUpdateResponse
     * @throws \Polar\Models\Errors\APIException
     */
    ...
    {
        $request = new Operations\CheckoutsClientUpdateRequest(
            clientSecret: $clientSecret,
            checkoutUpdatePublic: $checkoutUpdatePublic,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/checkouts/client/{client_secret}', Operations\CheckoutsClientUpdateRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'checkouts:client_update', null, null);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        $statusCode = $httpResponse->getStatusCode();
        if (Utils\Utils::matchStatusCodes($statusCode, ['403', '404', '410', '422', '4XX', '5XX'])) {
            $res = $this->sdkConfiguration->hooks->afterError(new Hooks\AfterErrorContext($hookContext), $httpResponse, null);
            $httpResponse = $res;
        }
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Polar\Models\Components\CheckoutPublic', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\CheckoutsClientUpdateResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    checkoutPublic: $obj);
     ...
     *
     * @param  \Polar\Models\Components\CheckoutCreate  $request
     * @return \Polar\Models\Operations\CheckoutsCreateResponse
     * @throws \Polar\Models\Errors\APIException
     */
    public function create(Components\CheckoutCreate $request, ?Options $options = null): Operations\CheckoutsCreateResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'checkouts:create', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     *
     * @param  string  $id
     * @return \Polar\Models\Operations\CheckoutsGetResponse
     * @throws \Polar\Models\Errors\APIException
     */
    public function get(string $id, ?Options $options = null): Operations\CheckoutsGetResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'checkouts:get', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * **Scopes**: `checkouts:read` `checkouts:write`
     *
     * @param  ?\Polar\Models\Operations\CheckoutsListRequest  $request
     * @return \Polar\Models\Operations\CheckoutsListResponse
     * @throws \Polar\Models\Errors\APIException
     */
    private function listIndividual(?Operations\CheckoutsListRequest $request = null, ?Options $options = null): Operations\CheckoutsListResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'checkouts:list', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
     ...
     *
     * @param  ?\Polar\Models\Operations\CheckoutsListRequest  $request
     * @return \Generator<\Polar\Models\Operations\CheckoutsListResponse>
     * @throws \Polar\Models\Errors\APIException
     */
     ...
     * **Scopes**: `checkouts:write`
     *
     * @param  \Polar\Models\Components\CheckoutUpdate  $checkoutUpdate
     * @param  string  $id
     * @return \Polar\Models\Operations\CheckoutsUpdateResponse
     * @throws \Polar\Models\Errors\APIException
     */
    ...
    {
        $request = new Operations\CheckoutsUpdateRequest(
            id: $id,
            checkoutUpdate: $checkoutUpdate,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/checkouts/{id}', Operations\CheckoutsUpdateRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PATCH', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'checkouts:update', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Polar\Models\Components\Checkout', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\CheckoutsUpdateResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    checkout: $obj);

...
class Checkouts
{
     ...
     * @throws \Polar\Models\Errors\APIException
     */
    public function create(Components\CheckoutProductCreate|Components\CheckoutPriceCreate $request, ?Options $options = null): Operations\CheckoutsCreateResponse
    {
        $baseUrl = $this->sdkConfiguration->getServerUrl();

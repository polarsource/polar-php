...
class Payments
{
    ...
    {
        $request = new Operations\PaymentsGetRequest(
            id: $id,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/payments/{id}', Operations\PaymentsGetRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'payments:get', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Polar\Models\Components\CardPayment|\Polar\Models\Components\GenericPayment', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PaymentsGetResponse(
    ...
    private function listIndividual(?Operations\PaymentsListRequest $request = null, ?Options $options = null): Operations\PaymentsListResponse
    {
        ...
        $qp = Utils\Utils::getQueryParams(Operations\PaymentsListRequest::class, $request, $urlOverride);
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'payments:list', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
                ...
                $response->next = function () use ($sdk, $request, $responseData): ?Operations\PaymentsListResponse {
                    ...
                    return $sdk->listIndividual(
                        request: new Operations\PaymentsListRequest(
                            ...
                            customerEmail: $request != null ? $request->customerEmail : null,
                            page: $nextPage,

...
class Clients
{
    ...
    public function create(Components\OAuth2ClientConfiguration $request, ?Options $options = null): Operations\Oauth2ClientsOauth2CreateClientResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'oauth2:clients:oauth2:create_client', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $clientId, ?Options $options = null): Operations\Oauth2ClientsOauth2DeleteClientResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'oauth2:clients:oauth2:delete_client', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['204'])) {
            ...
            return new Operations\Oauth2ClientsOauth2DeleteClientResponse(
                statusCode: $statusCode,
                contentType: $contentType,
                rawResponse: $httpResponse
            );
    ...
    public function get(string $clientId, ?Options $options = null): Operations\Oauth2ClientsOauth2GetClientResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'oauth2:clients:oauth2:get_client', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function update(Components\OAuth2ClientConfigurationUpdate $oAuth2ClientConfigurationUpdate, string $clientId, ?Options $options = null): Operations\Oauth2ClientsOauth2UpdateClientResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'oauth2:clients:oauth2:update_client', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {

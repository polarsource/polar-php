...
class PolarCustomers
{
    ...
    public function addPaymentMethod(Operations\CustomerPortalCustomersAddPaymentMethodSecurity $security, Components\CustomerPaymentMethodCreate $request, ?Options $options = null): Operations\CustomerPortalCustomersAddPaymentMethodResponse
    {
        ...
        $hookContext = new HookContext('customer_portal:customers:add_payment_method', null, fn () => $security);
    ...
    public function deletePaymentMethod(Operations\CustomerPortalCustomersDeletePaymentMethodSecurity $security, string $id, ?Options $options = null): Operations\CustomerPortalCustomersDeletePaymentMethodResponse
    {
        ...
        $hookContext = new HookContext('customer_portal:customers:delete_payment_method', null, fn () => $security);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function get(Operations\CustomerPortalCustomersGetSecurity $security, ?Options $options = null): Operations\CustomerPortalCustomersGetResponse
    {
        ...
        $hookContext = new HookContext('customer_portal:customers:get', null, fn () => $security);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    private function getPaymentMethodsIndividual(Operations\CustomerPortalCustomersGetPaymentMethodsSecurity $security, ?int $page = null, ?int $limit = null, ?Options $options = null): Operations\CustomerPortalCustomersGetPaymentMethodsResponse
    {
        ...
        $hookContext = new HookContext('customer_portal:customers:get_payment_methods', null, fn () => $security);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    public function update(Operations\CustomerPortalCustomersUpdateSecurity $security, ?Components\CustomerPortalCustomerUpdate $request = null, ?Options $options = null): Operations\CustomerPortalCustomersUpdateResponse
    {
        ...
        $hookContext = new HookContext('customer_portal:customers:update', null, fn () => $security);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {

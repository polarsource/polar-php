...
class PolarOrders
{
    ...
    public function confirmRetryPayment(Operations\CustomerPortalOrdersConfirmRetryPaymentSecurity $security, Components\CustomerOrderConfirmPayment $customerOrderConfirmPayment, string $id, ?Options $options = null): Operations\CustomerPortalOrdersConfirmRetryPaymentResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['404', '409', '422', '4XX', '5XX'])) {
    ...
    public function generateInvoice(Operations\CustomerPortalOrdersGenerateInvoiceSecurity $security, string $id, ?Options $options = null): Operations\CustomerPortalOrdersGenerateInvoiceResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['202'])) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Polar\Models\Errors\PolarExceptionsInvoiceAlreadyExists', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Polar\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Polar\Models\Errors\PolarExceptionsMissingInvoiceBillingDetails|\Polar\Models\Errors\PolarExceptionsNotPaidOrder', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
